...
function ParentProfilForma(props) {
    return (
        <div>
            <form onSubmit={props.submitEditProfile}> 
                ...
                <div className="form-group">
                    ...
                    <input 
                        ...
                        className="form-control" 
                        name="streetNumber" 
                        value={props.parentAddress.streetNumber} 
                ...
                <div className="form-group">
                    ...
                    <input 
                        ...
                        className="form-control" 
                        name="street" 
                        value={props.parentAddress.street}
                        onChange={props.changedAddress} />
                </div>
                <div className="form-group">
                    ...
                    <input 
                        ...
                        className="form-control" 
                        name="city" 
                        value={props.parentAddress.city} 
                        onChange={props.changedAddress}/>
                </div>
...
export default ParentProfilForma
